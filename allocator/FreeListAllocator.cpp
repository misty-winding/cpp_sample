...
void* FreeListAllocator::allocate(size_t size, u8 alignment)
{
    ...
    FreeBlock* prev_free_block = NULL;
    ...
    while(free_block != NULL)
    {
        ...
        // static_assertion(sizeof(AllocationHeader) >=
        //     sizeof(FreeBlock), "sizeof(AllocationHeader) < sizeof(FreeBlock)");
...
void FreeListAllocator::deallocate(void* p)
{
    ...
    if( free_block != NULL && (uptr) free_block == block_end)
    {
